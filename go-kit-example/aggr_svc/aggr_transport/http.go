...
func NewHTTPClient(instance string, logger log.Logger) (aggrservice.Service, error) {
...
func decodeHTTPAggregateResponse(_ context.Context, r *http.Response) (interface{}, error) {
	...
	var resp aggrendpoint.AggregateResponse
...
func decodeHTTPCalculateResponse(_ context.Context, r *http.Response) (interface{}, error) {
	...
	var resp aggrendpoint.CalculateResponse
	err := json.NewDecoder(r.Body).Decode(&resp)
	return resp, err
}
